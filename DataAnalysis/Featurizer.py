...
def create_npy_file(feat, default=True):
    """
...
def rm_periodic_boundary_cond(feat):
    """ 
    ...
    Returns:
	new_xtc: filepath to new trajectory file
    """
    ...
    os.system('echo "%d\n%d\n" | gmx trjconv -f /home/server/server2/data/SVR166219/PROJ%d/RUN%d/CLONE%d/results%s/traj_comp.xtc -s \
              ...
              % (indx1, indx2, feat.proj_num, feat.run_num, feat.clone_num, feat.gen_num, feat.proj_num, feat.run_num, feat.clone_num, feat.proj_num, feat.proj_num,
		 feat.run_num, feat.clone_num, feat.gen_num))
    new_xtc = '/home/server/git/fah-scripts/DataAnalysisScripts/temp_xtc/traj_%d_%d_%d_%d.xtc' % (feat.proj_num, feat.run_num, feat.clone_num, feat.gen_num)
    return new_xtc 
